--- ESTE ES EL DIRECTORIO PARA IMPLEMENTAR LAS FUNCIONES DE FORMA DEFINITIVA ---
voy a poner la clase base, esa no se toca, es para definir las funciones que tenemos que implementar 
cada uno subirá sus funciones implementadas, en un archivo aparte (no en la clase original, que se nos lía) además de los tests que le toquen (también separados)
