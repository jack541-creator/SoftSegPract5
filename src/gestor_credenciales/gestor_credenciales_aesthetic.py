...
# ---- clases para errores (excepciones)  ----------------------------------------------------------------------
class ErrorPoliticaPassword(Exception):pass
class ErrorAutenticacion(Exception):pass
class ErrorServicioNoEncontrado(Exception):pass
class ErrorCredencialExistente(Exception):pass
class ErrorCorreoNoEstablecido(Exception):pass
class ErrorCodigoNoEstablecido(Exception):pass
class ErrorSinIntentosRestantes(Exception):pass
class ErrorUsuarioYaVerificado(Exception):pass
#---- clase principal -------------------------------------------------------------------------------
class GestorCredenciales:
    ...
    #2º establecer el correo verificando que este es correcto  ============
    ...
    def enviar_correo2fa(self, clave_maestra: str, servicio: str, usuario: str) -> None:
        ...
        pass
    #7º verificar usuario con código 2FA ==========
    ...
    #8º comprobar si el usuario está verificado ===========
